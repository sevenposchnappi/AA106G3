...
<body bgcolor='white'>
	...
	<table border='1' cellpadding='5' cellspacing='0' width='400'>
		<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
			<td><h3>AnimalMAP StrayAni: Home</h3>	<font color=red>( MVC )</font></td></tr></table>

<p>This is the Home page for AnimalMAP StrayAni: Home</p>
...
<ul>
  <li><a href='listAllStrayani.jsp'>List</a> all Stray Animals. </li> <br><br>
     ...
     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/strayani/strayani.do" >
       ...
       <select size="1" name="stray_Ani_Id">
         <c:forEach var="strayaniVO" items="${strayaniSvc.all}" > 
          <option value="${strayaniVO.stray_Ani_Id}">${strayaniVO.stray_Ani_Id}
         </c:forEach>   
       </select>
       <input type="submit" value="送出">
       <input type="hidden" name="action" value="getOne_For_Display">
...
<ul>
  <li><a href='addStrayani.jsp'>Add</a> a new Strayani.</li>
</ul>
