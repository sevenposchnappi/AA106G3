...
public class StrayaniMessageVO {
    ...
    private Timestamp stray_Ani_date;
    private String stray_Ani_status;
    private Timestamp stray_Ani_CreDate;
